    ...
    <div className="flex flex-col h-[calc(100vh-140px)] max-w-5xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 bg-gradient-to-br from-[#3D8B71] to-[#56C99A] rounded-2xl flex items-center justify-center text-white shadow-lg shadow-[#3D8B71]/20">
            <Sparkles size={24} />
          </div>
          <div>
            <h1 className="text-2xl font-bold text-gray-900 tracking-tight">AI Academic Tutor</h1>
            <div className="flex items-center gap-2">
              <span className="w-2 h-2 rounded-full bg-green-500 animate-pulse"></span>
              <span className="text-sm font-medium text-gray-500">Flexi is online and ready</span>
            </div>
          </div>
        </div>
      ...
      {/* Chat Container */}
      <div className="flex-1 min-h-0 flex flex-col bg-white border border-gray-100 rounded-[24px] shadow-sm overflow-hidden relative">
        ...
        >
          ...
          {isLoading && (
            ...
            >
              <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0 bg-[#FDFBF7] text-gray-400 border border-gray-100 border-dashed animate-pulse">
                <Bot size={20} />
              </div>
          ...
          <div className="px-8 pb-4 flex flex-wrap gap-2">
            {[
              ...
              <button
                ...
                className="px-4 py-2 bg-gray-50 hover:bg-[#E6F3EE] hover:text-[#3D8B71] text-gray-500 rounded-full text-xs font-bold transition-all border border-gray-100"
              >
                {chip}
              </button>
            ))}
        ...
        <div className="p-6 border-t border-gray-100 bg-white shadow-[0_-4px_20px_rgba(0,0,0,0.02)]">
          <div className="relative flex items-center">
            <input
              ...
              className="w-full bg-gray-50 border border-gray-200 rounded-2xl px-6 py-4 pr-16 focus:outline-none focus:ring-4 focus:ring-[#3D8B71]/5 focus:border-[#3D8B71]/50 transition-all text-[15px] placeholder:text-gray-400"
            />
            <button
              onClick={handleSend}
              disabled={!input.trim() || isLoading}
              className="absolute right-2 top-2 bottom-2 w-12 bg-[#3D8B71] hover:bg-[#2E6854] disabled:bg-gray-200 disabled:cursor-not-allowed text-white rounded-xl flex items-center justify-center transition-all active:scale-95 shadow-lg shadow-[#3D8B71]/20"
            >
              <Send size={20} />
            </button>
          </div>
