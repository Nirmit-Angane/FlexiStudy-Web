  ...
  return (
    <div className="flex w-full h-full bg-[#1C1F27] text-white shadow-[inset_0_0_150px_rgba(0,0,0,0.5)]">
      <div className="flex-1 flex flex-col justify-center p-16 md:p-24 border-r-2 border-[#3D8B71]/40 relative overflow-hidden bg-gradient-to-br from-transparent to-[#3D8B71]/5">
        ...
        <h3 className="text-4xl md:text-5xl font-black mb-6 text-[#56C99A] tracking-tight drop-shadow-md text-balance">{data.leftTitle}</h3>
        <p className="text-2xl md:text-3xl leading-relaxed opacity-95 text-balance">{data.leftBody}</p>
      </div>
      <div className="flex-1 flex flex-col justify-center p-16 md:p-24 relative overflow-hidden bg-gradient-to-bl from-transparent to-[#4A7FC1]/5">
        ...
        <h3 className="text-4xl md:text-5xl font-black mb-6 text-[#6BA5F2] tracking-tight drop-shadow-md text-balance">{data.rightTitle}</h3>
        <p className="text-2xl md:text-3xl leading-relaxed opacity-95 text-balance">{data.rightBody}</p>
      </div>
    </div>
  );
};
